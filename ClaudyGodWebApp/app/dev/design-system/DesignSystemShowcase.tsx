      ...
      <div className="container-site space-y-20">
        ...
        <header className="space-y-4">
          ...
          <Text size="lg" color="secondary" className="max-w-2xl">
            Every primitive in <code className="text-gold-400">components/ui/</code>, rendered here
            so it&apos;s visible and gets reused instead of re-invented per page. If a component you
            need doesn&apos;t exist below, add it here — don&apos;t hand-roll markup in a page
            component.
          </Text>
        </header>
        ...
        <section>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <Accent className="mt-2">
                &ldquo;Sing unto the Lord a new song.&rdquo; — Psalm 96:1
              </Accent>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <IconButton label="Like" variant="primary">
              <Heart className="h-4 w-4" />
            </IconButton>
            <IconButton label="Add to bag" variant="outline">
              <ShoppingBag className="h-4 w-4" />
            </IconButton>
            <IconButton label="Delete" variant="soft">
              <Trash2 className="h-4 w-4" />
            </IconButton>
            <IconButton label="Like" variant="ghost">
              <Heart className="h-4 w-4" />
            </IconButton>
            <IconButton label="Like" variant="white">
              <Heart className="h-4 w-4" />
            </IconButton>
          </div>
        </section>
        ...
        <section>
          ...
          <Text size="sm" className="mb-4 max-w-xl">
            ...
            every hand-rolled `fixed inset-0` modal in the app that was missing them. Three
            variants: centered modal, side drawer, and full-screen overlay.
          </Text>
          <div className="flex flex-wrap gap-3">
          ...
          <Dialog open={fullscreenOpen} onOpenChange={setFullscreenOpen}>
            <Dialog.Content
              title="Example full-screen overlay"
              variant="fullscreen"
