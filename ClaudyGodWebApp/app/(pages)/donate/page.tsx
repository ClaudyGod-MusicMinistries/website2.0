...
export const metadata: Metadata = {
  ...
  keywords: [
    'donate ClaudyGod',
    'support ClaudyGod ministry',
    'gospel ministry donation Nigeria',
    'Christian ministry partner',
    'support gospel music Nigeria',
    'give to gospel ministry',
    'ClaudyGod ministry partner',
    'support Nigerian gospel artist',
    'gospel music production support',
    'ministry outreach donation',
    'Christian giving Nigeria',
    'support worship ministry',
    'sow into gospel ministry',
    'faith giving Nigeria',
  ],
  openGraph: {
    title: 'Donate — Partner with ClaudyGod Music Ministries',
    description:
