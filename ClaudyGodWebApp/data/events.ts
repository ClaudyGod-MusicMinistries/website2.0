...
export const placeholderEvents: Event[] = [
  {
    ...
    description:
      'Join us for an evening of praise, worship, and ministry. Experience the presence of God through spirit-filled music and worship.',
    fullDescription:
  ...
  },
  {
    ...
    description:
      'A night of outstanding gospel music, worship, and ministry. Experience 7 albums of music performed live with powerful testimonies.',
    fullDescription:
  ...
  },
  {
    ...
    description:
      'A conference focused on youth and young adult empowerment through gospel music, mentorship, and spiritual growth.',
    fullDescription:
  ...
  },
  {
    ...
    description:
      'A comprehensive training program for aspiring gospel musicians and ministers seeking to develop their craft and calling.',
    fullDescription:
  ...
  },
  {
    ...
    description:
      "A week-long spiritual renewal program focused on prayer, fasting, intercession, and encountering God's presence.",
    fullDescription:
  ...
  },
  {
    ...
    description:
      'An exclusive masterclass on vocal techniques, stage performance, and professional music production with Minister ClaudyGod.',
    fullDescription:
