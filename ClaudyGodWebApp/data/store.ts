...
export const products: Product[] = [
  {
    ...
    description: 'Ceramic mug with the ClaudyGod Music & Ministries crest on one side and an inspirational message on the reverse — perfect for your daily coffee, tea, or devotional moments.',
    rating: 5.0,
  },
  {
    id: '3',
