      ...
      <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 text-center">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-white text-[#111] hover:bg-neutral-100 px-5 sm:px-6 h-12 sm:h-14 transition-all duration-300 rounded-xl w-[152px] sm:w-auto sm:min-w-[168px]"
          >
