  ...
  return (
    ...
    <section className="relative bg-white section-py overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <AmbientGlow color="purple" size={600} opacity={0.05} animate={false} className="-top-[250px] -right-[200px]" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="font-sans text-neutral-500 text-base leading-relaxed mb-8 sm:mb-10 max-w-md">
              Experience the powerful visuals and soul-stirring worship from our latest release. Watch,
              listen, and share this anointed moment with your community.
            </p>
