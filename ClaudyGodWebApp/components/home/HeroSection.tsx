    ...
    <section className="relative w-full h-screen min-h-[600px] flex items-end overflow-hidden">
      ...
      <div className="relative z-10 w-full container-site pb-24 md:pb-32">
        ...
        >
          ...
          <span className="font-sans text-[0.58rem] tracking-[0.28em] uppercase text-gold-400/80">
        ...
        <motion.h1
          ...
          className="font-display font-extrabold text-white text-5xl md:text-6xl tracking-tight leading-[1.04] max-w-2xl"
        >
          Worship.{' '}
        ...
        >
          <Link
            href="/bookings"
            className="h-12 px-8 bg-purple-600 hover:bg-purple-500 text-white font-sans text-[0.6rem] tracking-[0.22em] uppercase transition-all duration-300 inline-flex items-center"
          >
            Book Now
          </Link>
          <Link
            href="/music"
            className="h-12 px-8 border border-white/20 hover:border-white/50 text-white/80 hover:text-white font-sans text-[0.6rem] tracking-[0.22em] uppercase transition-all duration-300 inline-flex items-center gap-2"
          >
            Listen Now
