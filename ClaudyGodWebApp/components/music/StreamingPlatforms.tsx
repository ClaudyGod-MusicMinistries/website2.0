            ...
            {securedMusicPlatforms.map((platform) => {
              ...
              return (
                <a
                  ...
                  className="inline-flex items-center gap-2.5 px-5 h-11 border border-neutral-200 rounded-xl hover:border-[var(--brand)]/60 bg-white hover:bg-[var(--brand)]/5 text-neutral-500 hover:text-[var(--brand)] font-sans text-xs tracking-[0.15em] uppercase transition-all duration-300 shadow-sm"
                >
