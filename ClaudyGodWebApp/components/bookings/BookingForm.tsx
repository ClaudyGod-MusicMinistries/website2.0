      ...
      if (err instanceof BackendError) {
        if (Object.keys(err.fieldErrors).length > 0) {
          ...
          showError(
            ...
            'We found some issues with your booking request. Please review and try again.',
            fieldErrors
          );
          const step0Fields = [
            'firstName',
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        {step === 2 && (
          <div className="space-y-5">
            ...
            <div>
              <Label>
                Address Line 2 <span className="font-normal text-neutral-400">(optional)</span>
              </Label>
              <input
                {...register('address2')}
        ...
        <div className="flex items-center justify-between mt-10 pt-6 border-t border-neutral-100 gap-4">
          ...
          {step < steps.length - 1 ? (
            <button
              ...
              onClick={next}
              disabled={isStepLoading}
              className="inline-flex items-center gap-2 h-12 px-8 bg-purple-600 hover:bg-purple-500 disabled:bg-purple-300 disabled:cursor-not-allowed active:bg-purple-700 text-white font-display font-bold text-sm rounded-xl transition-all duration-200 shadow-purple-cta hover:shadow-purple-cta-hover"
            >
