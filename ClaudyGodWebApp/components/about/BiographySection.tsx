      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start mb-20 lg:mb-32">
          <div className="lg:pt-4">
            ...
            <h2 className="font-raleway font-extralight text-white text-3xl md:text-4xl tracking-tight leading-tight mb-8">
              Called to Worship
            </h2>
          ...
          <div className="lg:pt-4 order-1 lg:order-2">
            ...
            <div className="mt-12 pt-10 border-t border-white/[0.06] grid grid-cols-3 gap-6">
              {[
                ...
                <div key={stat.label}>
                  <p className="font-raleway font-extralight text-gold-400 text-3xl md:text-4xl tracking-tight">
                    {stat.number}
                  </p>
